...
//line 188 for graph scaling, line 32 for line thickness
const LineGraph = () => {
  if(typeof window !== 'undefined'){
    ...
    useEffect(() => {
      if(typeof window !== 'undefined'){
        ...
        let aspecRatio = null
        aspecRatio = (window?.innerWidth - 100)/(aspecheight * (window?.innerWidth - 100)) * 100
    ...
    return (
      <>
      {typeof window !== 'undefined' && <div className="d-flex flex-column align-items-center p-3" ref={containerRef}>
